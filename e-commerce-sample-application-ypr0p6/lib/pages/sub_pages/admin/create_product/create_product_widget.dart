...
class _CreateProductWidgetState extends State<CreateProductWidget> {
  ...
  void initState() {
    ...
    _model.panjangTextController ??= TextEditingController();
    _model.panjangFocusNode ??= FocusNode();

    _model.lebarTextController ??= TextEditingController();
    _model.lebarFocusNode ??= FocusNode();

    _model.tinggiTextController ??= TextEditingController();
    _model.tinggiFocusNode ??= FocusNode();

    _model.beratTextController ??= TextEditingController();
    _model.beratFocusNode ??= FocusNode();
                                              ...
                                              if (selectedMedia != null &&
                                                  selectedMedia.every((m) =>
                                                      validateFileFormat(
                                                          ...
                                                          context))) {
                                                safeSetState(() => _model
                                                        .isDataUploading_uploadImageprodUsy =
                                                    true);
                                                ...
                                                try {
                                                  ...
                                                  _model.isDataUploading_uploadImageprodUsy =
                                                      false;
                                                }
                                                if (selectedUploadedFiles
                                                    ...
                                                    downloadUrls.length ==
                                                        selectedMedia.length) {
                                                  safeSetState(() {
                                                    _model.uploadedLocalFile_uploadImageprodUsy =
                                                        selectedUploadedFiles
                                                            .first;
                                                    _model.uploadedFileUrl_uploadImageprodUsy =
                                                        downloadUrls.first;
                                                  });
                                                } else {
                                                  safeSetState(() {});
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  TextFormField(
                                                    controller: _model
                                                        .panjangTextController,
                                                    focusNode:
                                                        _model.panjangFocusNode,
                                                    autofocus: true,
                                                    textCapitalization:
                                                        TextCapitalization
                                                            .words,
                                                    ...
                                                    cursorColor:
                                                        FlutterFlowTheme.of(
                                                            ...
                                                            .primary,
                                                    validator: _model
                                                        .panjangTextControllerValidator
                                                        .asValidator(context),
                                                    inputFormatters: [
                                                      if (!isAndroid && !isiOS)
                                                        TextInputFormatter
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  TextFormField(
                                                    controller: _model
                                                        .tinggiTextController,
                                                    focusNode:
                                                        _model.tinggiFocusNode,
                                                    autofocus: true,
                                                    textCapitalization:
                                                        TextCapitalization
                                                            .words,
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (selectedMedia != null &&
                                                    selectedMedia.every((m) =>
                                                        validateFileFormat(
                                                            ...
                                                            context))) {
                                                  safeSetState(() => _model
                                                          .isDataUploading_uploadedProductImage =
                                                      true);
                                                  var selectedUploadedFiles =
                                                      <FFUploadedFile>[];
                                                  ...
                                                  try {
                                                    ...
                                                    _model.isDataUploading_uploadedProductImage =
                                                        false;
                                                  }
                                                  if (selectedUploadedFiles
                                                              .length ==
                                                      ...
                                                      downloadUrls.length ==
                                                          selectedMedia
                                                              .length) {
                                                    safeSetState(() {
                                                      _model.uploadedLocalFile_uploadedProductImage =
                                                          selectedUploadedFiles
                                                              .first;
                                                      _model.uploadedFileUrl_uploadedProductImage =
                                                          downloadUrls.first;
                                                    });
                                                  } else {
                                                    safeSetState(() {});
                                                ...
                                                await ProductsRecord.collection
                                                  ...
                                                  ...createProductsRecordData(
                                                    ...
                                                    category:
                                                        _model.categoryValue,
                                                    panjang: int.tryParse(_model
                                                        .panjangTextController
                                                        .text),
                                                    lebar: int.tryParse(_model
                                                        .lebarTextController
                                                        .text),
                                                    tinggi: int.tryParse(_model
                                                        .tinggiTextController
                                                        .text),
                                                    berat: int.tryParse(_model
                                                        .beratTextController
                                                        .text),
                                                  ),
                                                  ...mapToFirestore(
                        ...
                        onPressed: () async {
                          await ProductsRecord.collection.doc().set({
                            ...createProductsRecordData(
                              ...
                              photoUrl:
                                  _model.uploadedFileUrl_uploadImageprodUsy,
                              qty: _model.qtyTextController.text,
                              price:
                                  int.tryParse(_model.hargaTextController.text),
