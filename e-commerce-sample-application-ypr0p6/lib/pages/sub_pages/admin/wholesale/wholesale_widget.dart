...
class WholesaleWidget extends StatefulWidget {
  const WholesaleWidget({super.key});
                                        ...
                                        if (responsiveVisibility(
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                await WholesaleRecord.collection
                                                    .doc()
                                                    .set(
                                                        createWholesaleRecordData(
                                                      supplierRef: _model
                                                          .supplierTextController
                                                          .text,
                                                      ...
                                                      harga: int.tryParse(_model
                                                          .hargaTextController
                                                          .text),
                                                      total: int.tryParse(_model
                                                          .qtyTextController
                                                          .text),
                                                    ));
                                              },
